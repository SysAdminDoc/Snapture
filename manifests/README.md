...
- The MSIX manifest is maintained under `packaging/msix/` and is generated by `build/build.ps1`.
  Local MSIX output remains unsigned; Store or hosted-feed publication is operator-controlled.
